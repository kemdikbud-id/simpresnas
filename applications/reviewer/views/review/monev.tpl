	...
	<div class="row">
		<div class="col-lg-12">
			...
			<form method="post" action="{current_url()}" class="form-horizontal">
				...
				{foreach $penilaian_set as $penilaian}
					<div class="form-group">
						<label for="komentar">Komentar atas penilaian {$penilaian->kriteria}</label>
						<textarea class="form-control" rows="2" name="komentar_penilaian[{$penilaian->komponen_penilaian_id}]">{$penilaian->komentar}</textarea>
					</div>
				{/foreach}
