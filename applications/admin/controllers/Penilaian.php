...
class Penilaian extends Admin_Controller
{
	...
	public function index()
	{
		...
		$data_set = $this->db
			->select('p.judul, pt.nama_pt, r1.nama as reviewer_1, r2.nama as reviewer_2')
			->select('pr1.biaya_rekomendasi as biaya_rekomendasi_1, pr2.biaya_rekomendasi as biaya_rekomendasi_2')
			->select('pr1.nilai_reviewer as nilai_reviewer_1, pr2.nilai_reviewer as nilai_reviewer_2, ABS(pr1.nilai_reviewer - pr2.nilai_reviewer) as nilai_selisih')
			...
			->group_by('p.judul, pt.nama_pt, r1.nama, r2.nama, pr1.nilai_reviewer, pr2.nilai_reviewer, pr1.biaya_rekomendasi, pr2.biaya_rekomendasi')
			->order_by('10 DESC, 11 DESC', NULL, FALSE) // AVG & SUM
			->get()->result();
