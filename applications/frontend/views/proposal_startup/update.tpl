...
{block name='content'}
	<h2 class="page-header">Edit Info Startup</h2>
	<div class="row">
		<div class="col-lg-12">
			...
			<form action="{current_url()}" method="post" class="form-horizontal">
				...
				<fieldset>
					...
					<div class="form-group">
						<label class="col-lg-2 control-label">Nama Startup</label>
						<div class="col-lg-10">
							{if $proposal->is_submited or $proposal->is_reviewed}
								<p class="form-control-static">{$proposal->judul}</p>
							{else}
								<input type="text" name="judul" class="form-control" placeholder="Nama produk startup yang diusulkan" required value="{$proposal->judul}"/>
							{/if}
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-lg-offset-2 col-lg-4">
							<a href="{site_url('proposal-startup/index')}" class="btn btn-default">Kembali</a>
