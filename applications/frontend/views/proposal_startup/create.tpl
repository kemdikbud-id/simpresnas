...
{block name='content'}
	<h2 class="page-header">Tambah Usulan Startup Baru</h2>
	<div class="row">
		<div class="col-lg-12">
					...
					<form action="{current_url()}" method="post" class="form-horizontal">
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" name="judul" class="form-control" placeholder="Nama produk startup yang diusulkan" required />
								</div>
							</div>
